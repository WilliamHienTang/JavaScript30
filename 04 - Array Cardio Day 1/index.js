...
result = inventors.filter(i => (i.year >= 1500 && i.year < 1600));
console.table(result);

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
result = inventors.map(i => `${i.first} ${i.last}`);
console.table(result);
...
result = inventors.sort(sortBirthdate);
console.table(result);
...
function sortYearsLived(a, b){
  return (a.passed-a.year)-(b.passed-b.year);
}
result = inventors.sort(sortYearsLived);
console.table(result);
